...
class Morasep:
    ...
    #
    # Working
    # 1. If the output format is "hiragana", checks if the mora is in kanamap keys and converts katakana to hiragana.
    # 2. If the output format is "katakana", checks if the mora is in kanamap keys and converts hiragana to katakana.
    # 3. If the output format is in `kanamap` headers, convert it from hiragana to katakana, and check if the mora is in kanamap keys and then convert into a special format
